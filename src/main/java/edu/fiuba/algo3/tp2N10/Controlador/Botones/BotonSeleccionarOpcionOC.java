...
public class BotonSeleccionarOpcionOC implements EventHandler<ActionEvent>{
    ...
    public BotonSeleccionarOpcionOC(Button boton, Integer numeroOpcion, List<Integer> respuestaUsuario, Label respuestaOrdenada){
        this.boton = boton;
    ...
    public void handle(ActionEvent actionEvent) {
        ...
        this.respuestaOrdenada.setText((this.respuestaOrdenada.getText() == "") ? opcion: this.respuestaOrdenada.getText() + "-" + opcion);
